                    ...
                    if (this.p.colNames.length !== this.p.colModel.length) alert(b.jgrid.errors.model);
                        ...
                        var r = function(a, b) {
                            ...
                            qa = function(c, e) {
                                ...
                                !0 === a.p.pgbuttons ?
                                    (m = ["first" + e, "prev" + e, "next" + e, "last" + e], "rtl" === f && m.reverse(), g += "<td id='" + m[0] + "' class='ui-pg-button ui-corner-all'><a><span class='fa fa-fast-backward'></span></a></td>", g += "<td id='" + m[1] + "' class='ui-pg-button ui-corner-all'><a><span class='fa fa-backward'></span></a></td>", g = g + ("" !== d ? "<td class='ui-pg-button ui-state-disabled' style='width:4px;'><span class='ui-separator'></span></td>" + d + "<td class='ui-pg-button ui-state-disabled' style='width:4px;'><span class='ui-separator'></span></td>" :
                                        "") + ("<td id='" + m[2] + "' class='ui-pg-button ui-corner-all'><a><span class='fa fa-forward'></span></a></td>"), g += "<td id='" + m[3] + "' class='ui-pg-button ui-corner-all'><a><span class='fa fa-fast-forward'></span></a></td>") : "" !== d && (g += d);
                                "ltr" === f && (g += k);
                                g += "</tr></tbody></table>";
                        ...
                        var da = null,
                            k = b("<table class='ui-jqgrid-htable' id='tblhead' style='width:" + a.p.tblwidth + "px' role='grid' aria-labelledby='gbox_" + this.id + "' cellspacing='0' cellpadding='0' border='0'></table>").append(D),
                ...
                if (e.grid) {
                    ...
                    if (void 0 !== a("#" + a.jgrid.jqID(s.themodal))[0]) c(a("#fbox_" + a.jgrid.jqID(+e.p.id)));
                        ...
                        var x = a.extend([], e.p.colModel),
                            d = "<a id='" + h + "_search' class='fm-button ui-state-default ui-corner-all fm-button-icon-right ui-reset'>" +
                            b.Find + "</a>",
                ...
                if (!this.nav) {
                    ...
                    if (f.grid && "string" === typeof b) {
                        ...
                        for (x = 0; x < u; x++) {
                            ...
                            c.add && (h = h || {}, k = a("<td class='ui-pg-button ui-corner-all'></td>"), a(k).append("<div class='ui-pg-div'><span class='fa fa-refresh'" + c.addicon + "'></span>" + c.addtext + "</div>"), a("tr", g).append(k), a(k, g).attr({
                                title: c.addtitle || "",
                                id: h.id || "add_" + p
                            }).click(function() {
                            ...
                            c.edit && (k = a("<td class='ui-pg-button ui-corner-all'></td>"), e = e || {}, a(k).append("<div class='ui-pg-div'><span class='fa fa-refresh' " + c.editicon + "'></span>" + c.edittext + "</div>"), a("tr", g).append(k), a(k, g).attr({
                                title: c.edittitle || "",
                                id: e.id || "edit_" + p
                            }).click(function() {
                            ...
                            c.search && (k = a("<td class='ui-pg-button ui-corner-all'></td>"), t = t || {}, a(k).append("<a'><span class=' " +
                                c.searchicon + "'></span>" + c.searchtext + "</a>"), a("tr", g).append(k), a(k, g).attr({
                                title: c.searchtitle || "",
                                id: t.id || "search_" + p
                            }).click(function() {
                            ...
                            c.refresh && (k = a("<td class='ui-pg-button ui-corner-all'></td>"), a(k).append("<a><span class='" + c.refreshicon + "'></span>" + c.refreshtext +
                                "</a>"), a("tr", g).append(k), a(k, g).attr({
