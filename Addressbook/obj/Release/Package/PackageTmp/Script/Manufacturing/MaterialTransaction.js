var MaterialTransactionView = {
        ...
        MaterialTransactionView.variables.dx_dataGrid = $("#dx_dataGrid").dxDataGrid({
            ...
            columns: [{ dataField: "mt_id", allowFiltering: false, allowSorting: true, sortIndex: 1, sortOrder: "desc", visible: false },
                ...
                },
                {
                    ...
                    cellTemplate: function (container, options) {
                        DevExVariables.ActionTemplate(container, options, true, true, "MaterialTransactionView", "Attachments,Share,Pdf", "MaterialTransaction");
                    }
                },
            ]
        }).dxDataGrid("instance");
    ...
    ClearShareItemControlls: function () {
        ...
        MaterialTransactionView.variables.dx_txtVoucherMobileNo.option({ value: "" });
        MaterialTransactionView.variables.dx_txtShareMessage.option({ value: 'Dear Sir, ' + $("#hdn_UserName").val() + ' shared a design from TrinityJewells with you. Kindly click on below URL to view shared Design. {SHARE URL}' });
        MaterialTransactionView.variables.dx_txtSharingSubject.option({ value: "Jewellery Designs shared by TrinityJewells" });
