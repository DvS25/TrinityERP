var JewelleryTranscationView = {
                   ...
                   },
               {
               ...
               },
                {
                ...
                },
                 {
                     ...
                     cellTemplate: function (container, options) {
                         DevExVariables.ActionTemplate(container, options, true, true, "JewelleryTranscationView", "Attachments,Share,Pdf","JewelleryTranscation");
                     }
                 },
            ]
        }).dxDataGrid("instance");
    ...
    ClearShareItemControlls: function () {
        ...
        JewelleryTranscationView.variables.dx_txtVoucherMobileNo.option({ value: "" });
        JewelleryTranscationView.variables.dx_txtShareMessage.option({ value: 'Dear Sir, ' + $("#hdn_UserName").val() + ' shared a design from TrinityJewells with you. Kindly click on below URL to view shared Design. {SHARE URL}' });
    ...
    SharingDetails: function () {
        ...
        var ShareLink = getERPDomain() + "/Sharing/VoucherView?VoucherId=" + JewelleryTranscationView.variables.Masterid + "/VoucherType=JewelleryTranscation";
        var message = "";
        if (Type == "E-Mail") {
