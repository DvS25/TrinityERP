var QuotationMasterView = {
    ...
    ClearShareItemControlls: function () {
        ...
        QuotationMasterView.variables.dx_txtVoucherMobileNo.option({ value: "" });
        QuotationMasterView.variables.dx_txtShareMessage.option({ value: 'Dear Sir, ' + $("#hdn_UserName").val() + ' shared a design from TrinityJewells with you. Kindly click on below URL to view shared Design. {SHARE URL}' });
        QuotationMasterView.variables.dx_txtSharingSubject.option({ value: "Jewellery Designs shared by TrinityJewells" });
    ...
    SharingDetails: function () {
        ...
        var ShareLink = getB2BDomain() + "/QuotationView?QM_ID=" + QuotationMasterView.variables.Masterid;
        var message = "";
        if (Type == "E-Mail") {
