var ProductListAdsView = {
    variables: {
        BindGroupListUrl: "/Common/BindMastersDetails?ServiceName=B2C_CUSTOMERDETAILS_GET",
    ...
    initializeJqgrid: function () {
        ...
        colNames = ['Customer Id', 'First Name', 'Laste Name', 'Mobile Number', 'Email', 'Gender', 'City','State' , 'Contry'],
        colModel = [
                    { name: "CUSTOMERID", index: "CUSTOMERID", xmlmap: xmlvars.common_colmap + "CUSTOMERID", search: false, searchoptions: jqGridVariables.stringSearchOption, hidden: true },
                    { name: "FIRSTNAME", index: "FIRSTNAME", width: 10, xmlmap: xmlvars.common_colmap + "FIRSTNAME", search: true, searchoptions: jqGridVariables.stringSearchOption, hidden: false },
                    { name: "LASTNAME", index: "LASTNAME", width: 10, xmlmap: xmlvars.common_colmap + "LASTNAME", search: true, searchoptions: jqGridVariables.stringSearchOption, hidden: false },
                    { name: "MOBILENO", width: 10, index: "MOBILENO", xmlmap: xmlvars.common_colmap + "MOBILENO", search: true, sortable: false, searchoptions: jqGridVariables.stringSearchOption, hidden: false },
                    { name: "EMAILID", width: 20, index: "EMAILID", xmlmap: xmlvars.common_colmap + "EMAILID",  search: true, sortable: false, searchoptions: jqGridVariables.stringSearchOption, hidden: false },
                    { name: "GENDER", width: 10, index: "GENDER", xmlmap: xmlvars.common_colmap + "GENDER",  search: true, sortable: false, searchoptions: jqGridVariables.stringSearchOption, hidden: false },
                    { name: "CITYNAME", width: 10, index: "CITYNAME", xmlmap: xmlvars.common_colmap + "CITYNAME",  search: true, sortable: false, searchoptions: jqGridVariables.stringSearchOption, hidden: false },
                    { name: "STATENAME", width: 10, index: "STATENAME", xmlmap: xmlvars.common_colmap + "STATENAME", search: true, sortable: false, searchoptions: jqGridVariables.stringSearchOption, hidden: false },
                    { name: "CONTRYNAME", width: 10, index: "CONTRYNAME", xmlmap: xmlvars.common_colmap + "CONTRYNAME",  search: true, sortable: false, searchoptions: jqGridVariables.stringSearchOption, hidden: false },
        ];
        
        function imageWebFormat(cellvalue, options, rowObject) {
            return '<img style="width:35px !important; height:35px !important;" src="' + getDomain() + '/UploadFiles/Profile/' + cellvalue + '" />';
        }
        ...
        $("#table_list_productlistads").jqGrid({
            ...
            loadComplete: function () {
                ...
                $("#table_list_productlistads").jqGrid('setGridHeight', $(window).innerHeight() - 150 - ($("#gbox_table_list_productlistads").height() - $('#gbox_table_list_productlistads .ui-jqgrid-bdiv').height()));
