var BranchMasterView = {
    ...
    initializeDevExgrid: function ()     {
        BranchMasterView.variables.dx_dataGrid = $("#dx_dataGrid").dxDataGrid({
            ...
            columns: [{ dataField: "branchid", allowFiltering: false, allowSorting: true, sortIndex: 1, sortOrder: "desc", visible: false },
                ...
                { dataField: "pincode", caption: "PIN Code", dataType: "string", allowSorting: true, allowFiltering: false, allowHeaderFiltering: false },
    ...
    triggerId: function (id) {
        ...
        BranchMasterView.variables.dx_txtPINCode.option({ value: rowData.pincode });
    ...
    btnMasterSubmit: function () {
        ...
        var data = {
            ...
            //"PINCODE": BranchMasterView.variables.dx_txtPINCode.option().value,  
        ...
        if (BranchMasterView.variables.dx_txtPINCode.option().value)
            data.PINCODE = BranchMasterView.variables.dx_txtPINCode.option().value;
    ...
    ClearValues: function () {
        ...
        BranchMasterView.variables.dx_txtPINCode.option({ value: "" });
    ...
    FormInitialize: function () {
        ...
        BranchMasterView.variables.dx_txtPINCode = $("#dx_txtPINCode").dxTextBox({
            mode: "number",
