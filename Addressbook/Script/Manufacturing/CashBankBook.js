var CashBankBookView = {
    ...
    FormInitialize: function () {
        ...
        CashBankBookView.variables.dx_txtSharingSubject = $("#dx_txtSharingSubject").dxTextBox({
            value: "Payment Details shared by TrinityJewells"
        }).dxTextBox("instance");
    ...
    ClearShareItemControlls: function () {
        ...
        CashBankBookView.variables.dx_txtMobileNo.option({ value: "" });
        CashBankBookView.variables.dx_txtShareMessage.option({ value: 'Dear sir, Some Jewellery Designs are shared by Trinity Jewells with you. Kindly click on below URL to view shared Designs. {SHARE URL}' });
        CashBankBookView.variables.dx_txtSharingSubject.option({ value: "Payment Details shared by TrinityJewells" });
