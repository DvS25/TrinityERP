var GeneralExpenceView = {
    ...
    FormInitialize: function () {
        ...
        GeneralExpenceView.variables.dx_txtSharingSubject = $("#dx_txtSharingSubject").dxTextBox({
            value: "Journal Voucher shared by TrinityJewells"
        }).dxTextBox("instance");
    ...
    ClearShareItemControlls: function () {
        ...
        GeneralExpenceView.variables.dx_txtMobileNo.option({ value: "" });
        GeneralExpenceView.variables.dx_txtShareMessage.option({ value: 'Dear sir, Some Jewellery Designs are shared by Trinity Jewells with you. Kindly click on below URL to view shared Designs. {SHARE URL}' });
        GeneralExpenceView.variables.dx_txtSharingSubject.option({ value: "Journal Voucher shared by TrinityJewells" });
